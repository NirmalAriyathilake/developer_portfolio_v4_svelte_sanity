...
<div class={`top-0 flex w-full flex-col items-center bg-base-300 lg:flex-row ${className}`}>
	<div class="flex w-full flex-col items-start self-center px-10">
		...
		<h1 class="dash-title mt-5 text-2xl font-semibold lg:text-4xl">
			{data.yearsOfExperience}+ years of experience
		</h1>

		<div class="mt-10 flex flex-col gap-5 self-center lg:flex-row lg:self-start">
		...
		<div class="mt-10 flex flex-row flex-wrap items-center justify-center gap-3 self-center">
